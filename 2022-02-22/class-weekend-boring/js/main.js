...
function check() {
  ...
  const dayInput = document.querySelector('#day').value.toLowerCase();
  ...
  console.log(dayBoring);

  console.log(dayClass.includes(dayInput));
  console.log(dayWeekend.includes(dayInput));
  console.log(dayBoring.includes(dayInput));
...
function appOutput(message='You wanna try that again?') {
